...
export default function ClassesNavbar() {
  ...
  const handleSearchChange = (e) => {
    ...
    const matches = [...routes, ...classSubmenu].filter((route) =>
  ...
  const handleSearchSubmit = (e) => {
    ...
    const match = [...routes, ...classSubmenu].find((route) =>
      route.name.toLowerCase().includes(query)
    );
                ...
                `}
                  ...
                  {classSubmenu.map((submenu) => (
                    <li
                      ...
                      onClick={() =>
                        handleItemClick(submenu.name, submenu.path)
                      }
                    >
                      {submenu.name}
                    </li>
          ...
          <div className="md:hidden flex items-center">
            {!isSearchActive ? (
              ...
              <form
                ...
                className="flex items-center border-2 border-gray-300 rounded-lg p-1 w-48 sm:w-64"
              >
                <input
                  type="text"
                  value={searchQuery}
            ...
            <div className="absolute top-16 bg-white shadow-md p-2 mt-1 rounded-md w-48 sm:w-64">
              {suggestions.map((suggestion) => (
                <div
                  ...
                  onClick={() =>
                    handleItemClick(suggestion.name, suggestion.path)
                  }
                >
                  {suggestion.name}
                </div>
